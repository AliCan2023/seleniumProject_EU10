...
public class T1_DoubleClick {
    ...
    public void double_click_test1() {
        ...
        //2. Switch to iframe.
        Driver.getDriver().switchTo().frame("iframeResult");// accepts id or name of iframe;

        //3.Double click on the text“Double-click me to change my text color.”
        DoubleClickPage doubleClickPage = new DoubleClickPage();// relocate the freshness of the element reference
